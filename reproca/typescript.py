        ...
        match obj:
            ...
            case _:
                ...
                match orig:
                    ...
                    case type() if issubclass(orig, (list, set, frozenset, Collection, Sequence, MutableSequence, MutableSet)):
                        args = get_args(obj)
                        self.write("(")
                        self.type(args[0])
                        self.write(")[]")
    ...
    def struct(self, obj: type[msgspec.Struct]) -> None:
        ...
        for name, obj2 in ann.items():
            ...
            if (
                ...
                and any(True for field in msgspec.structs.fields(obj) if field.default is msgspec.UNSET)
            ):
